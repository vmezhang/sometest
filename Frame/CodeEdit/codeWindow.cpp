...
void CodeWindow::openFile()
{
    ...
    QString fileName = QInputDialog::getText(NULL, "open file", "Please input file name", QLineEdit::Normal);
...
int CodeWindow::saveFileAs(CodePad *tmp)
{
    //QString fileName = QFileDialog::getSaveFileName(
            //this, tr("Save File"),
            //tmp->getTabName());
    QString fileName = QInputDialog::getText(NULL, "save file", "Please input file name", QLineEdit::Normal);
